...
/* =============================================================================
   ...
   Game logic in frogger.c never calls any OS or library API directly.

   Want a new backend? Implement these 4 functions. That's it.

   JS analogy: think of this like a TypeScript interface:
     interface Platform { init, getTime, getInput }
     // displayBackbuffer handled internally by each backend
   ============================================================================= */
