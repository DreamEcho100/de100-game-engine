...
| ID | Task | Status |
|----|------|--------|
| update-snake-h | Rewrite `src/snake.h` — SnakeBackbuffer, SNAKE_RGB/A, GameButtonState, SNAKE_DIR enum, GameInput, updated GameState | ✅ done |
...
| write-lesson-03 | `lessons/lesson-03.md` — Color System: uint32_t, SNAKE_RGB, Named Constants | ✅ done |
