...
#define De100_MEMORY_FLAG_RWX (De100_MEMORY_FLAG_READ | De100_MEMORY_FLAG_WRITE | De100_MEMORY_FLAG_EXECUTE)
#define De100_MEMORY_FLAG_RW_ZEROED (De100_MEMORY_FLAG_RW | De100_MEMORY_FLAG_ZEROED)
 ...
 */
De100MemoryBlock de100_memory_alloc(void *base_hint, size_t size, De100MemoryFlags flags);
