 ...
 */
bool input_recording_begin(const char *exe_directory, GameMemoryState *state, int32 slot_index);
 ...
 */
bool input_recording_playback_begin(const char *exe_directory, GameMemoryState *state, int32 slot_index);
